...
def get_parser():
    ...
    parser.add_argument('--attack_frac', type=float, default=0)
    parser.add_argument('--attack_tau', type=float, default=1)
    ...
    parser.add_argument('--server-model', type=str, choices=['DiagSheaf', 'BundleSheaf', 'GeneralSheaf'], default='DiagSheaf')
    # Optimisation params
    ...
    parser.add_argument('--server_dropout', type=float, default=0.7) #0.7
    ...
    parser.add_argument('--client_vector_epochs', type=int, default=30)
